...
export function ServiceCard({
  ...
  return (
    <div
      className={`relative rounded-2xl p-8 transition-shadow duration-300 hover:shadow-lg flex flex-col ${
        featured
      ...
      {testimonial && (
        <div
          className={`mb-4 pl-4 border-l-2 ${
            featured ? "border-accent/40" : "border-secondary/30"
          }`}
        >
          <p
          ...
          {testimonial.attribution && (
            <p
              className={`text-xs mt-1 ${
                featured ? "text-gray-400" : "text-text-secondary/70"
              }`}
            >
